...
import { useTransfers } from "../hooks/useTransfers.hook";
            ...
            >
                {viewingTransfer && (
                    <div>
                        <p>
                            <strong>From:</strong>{" "}
                            {viewingTransfer.fromBase?.name}
                        </p>
                        <p>
                            <strong>To:</strong> {viewingTransfer.toBase?.name}
                        </p>
                        <p>
                            <strong>Equipment:</strong>{" "}
                            {viewingTransfer.equipmentType?.name}
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            {viewingTransfer.initiatedBy?.fullname}
                        </p>
                        <p>
                            <strong>Transport Details:</strong>{" "}
                            {viewingTransfer.transportDetails}
                        </p>
                        <p>
                            <strong>Notes:</strong> {viewingTransfer.notes}
                        </p>
                    </div>
                )}
            </Modal>
